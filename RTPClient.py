...
class RTPClient:
        ...
        def writeToFile(self,packList):
            ...
            f.close()
            print("Transformed: ",self.textfile)
            running = False
        ...
        def sendPackets(self):
            ...
            return self.send(self.clientSock, self.clientSockRecv)
        ...
        def receive(self,sock,sockRecv):
            ...
            while(not finished):
                ...
                if(not rewait):
                    ...
                    #print("Expecting Packet: ", expectedSeqNum)
                    ...
                    if(expectedSeqNum != 0):
                        ...
                        #print("Sending ACK FOR: ", int(expectedSeqNum - 1))
